            ...
            <el-form-item v-show="value.promotionType===1">
                <div>
                    ...
                    <el-date-picker
                            ...
                            type="datetime"
                            :picker-options="pickerOptionsStart(value.promotionEndTime)"
                            placeholder="选择开始时间">
                    </el-date-picker>
                </div>
                <div class="littleMargin">
                    ...
                    <el-date-picker
                            ...
                            value-format="timestamp"
                            type="datetime"
                            :picker-options="pickerOptionsEnd(value.promotionStartTime)"
                            placeholder="选择结束时间">
                    </el-date-picker>
                </div>
                <div class="littleMargin">
...
<script>
    import {fetchLevelData} from "../../../../api/ums/memberLevel";

        ...
        <div>
            ...
            <div class="container">
                ...
                <el-table :data="tableData"
                    ...
                    <el-table-column prop="attributeCount" label="属性数量" align="center"></el-table-column>
                    <el-table-column prop="paramCount" label="参数数量" align="center"></el-table-column>
